...
values (1, 'Мы', '00:02:48');

insert into track  (album_id, name, duration)
values (1, 'Вы', '00:03:02');

insert into track  (album_id, name, duration)
values (2, 'Сильная женщина', '00:03:10');

insert into track  (album_id, name, duration)
values (2, 'Наружу изнутри', '00:03:51');

insert into track  (album_id, name, duration)
values (3, 'Камнем по голове', '00:02:37');

insert into track  (album_id, name, duration)
values (3, 'Дурак и молния', '00:01:54');

insert into track  (album_id, name, duration)
values (4, 'Крылья', '00:03:45');

insert into track  (album_id, name, duration)
values (4, 'Дыхание', '00:03:39');

insert into track  (album_id, name, duration)
values (5, 'Чудак', '00:02:29');

insert into track  (album_id, name, duration)
values (5, 'Дочь самурая', '00:03:36');

insert into track  (album_id, name, duration)
values (6, 'Всё зависит от нас', '00:04:01');

insert into track  (album_id, name, duration)
values (7, 'Believer', '00:03:24');

insert into track  (album_id, name, duration)
values (7, 'Thunder', '00:03:07');

insert into track  (album_id, name, duration)
values (7, 'Whatever It Takes', '00:03:21');

insert into track  (album_id, name, duration)
values (8, 'WE ARE CHAOS', '00:04:00');

insert into track  (album_id, name, duration)
values (8, 'HALF-WAY & ONE STEP FORWARD', '00:03:16');

insert into track  (album_id, name, duration)
values (9, 'House of Gold', '00:02:43');

insert into track  (album_id, name, duration)
values (9, 'Fake You Out', '00:03:51');

insert into track  (album_id, name, duration)
values (10, 'Ich Will', '00:03:37');

insert into track  (album_id, name, duration)
values (10, 'Links 2 3 4', '00:03:36');
